        ...
        echo Html::beginTag('div',['class' => '']);
            echo Html::beginTag('table',['class' => 'table table-bordered']);
                ...
                echo Html::beginTag('thead');
                    echo Html::beginTag('tr');
                        echo Html::beginTag('th');
                            echo Html::beginTag('ul',['class' => 'list-inline head-pult']);
                                echo Html::beginTag('li');
                                    echo Html::beginTag('span',['class' => 'subject','type' => 'subject']);
                                        echo 'РУС('.$count_subject.')';
                                    echo Html::endTag('span');
                                echo Html::endTag('li');
                                echo Html::beginTag('li');
                                    echo Html::beginTag('span',['class' =>'rss','type' => 'rss']);
                                        echo 'ENG('.$count_rss_news.')';
                                    echo Html::endTag('span');
                                echo Html::endTag('li');
                                echo Html::beginTag('li');
                                    echo Html::beginTag('span',['class' =>'mail','type' => 'mail']);
                                        echo 'ПАРТНЕРЫ('.$count_mail_news.')';
                                    echo Html::endTag('span');
                                echo Html::endTag('li');
                            echo Html::endTag('ul');
                        echo Html::endTag('th');
                ...
                echo Html::beginTag('tbody');
                    echo Html::beginTag('tr');
                        echo Html::beginTag('td',['name' => 'td-left-area']);
